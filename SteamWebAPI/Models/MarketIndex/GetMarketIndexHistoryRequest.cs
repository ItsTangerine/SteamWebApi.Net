...
/// <summary>Options for <see cref="SteamWebApiClient.GetMarketIndexHistoryAsync"/>.</summary>
public sealed class GetMarketIndexHistoryRequest
{
    /// <summary>The metric to return history for. Defaults to <see cref="MarketIndexMetric.PriceIndex"/>.</summary>
    public MarketIndexMetric? Metric { get; set; }
    ...
    /// <summary>The maximum number of points to return (1–10000). Defaults to 1000.</summary>
